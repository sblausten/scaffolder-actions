...
| AWS           | `roadiehq:aws:ecr:create`              | Creates an AWS Elastic Container Registry (ECR) repository.                                       | [RoadieHQ AWS ECR](https://github.com/RoadieHQ/roadie-backstage-plugins/tree/main/plugins/scaffolder-actions/scaffolder-backend-module-aws)                                       | repoName*, tags, imageMutability, scanOnPush, region*                                                                             |
| AWS           | `roadiehq:aws:secrets-manager:create`  | Creates a new secret in AWS Secrets Manager using the Backstage scaffolder plugin.                 | [RoadieHQ Secrets Manager](https://github.com/RoadieHQ/roadie-backstage-plugins/blob/main/plugins/scaffolder-actions/scaffolder-backend-module-aws/src/actions/secrets-manager/create.ts) | name*, description, value, tags, profile, region*                                                                                 |
| AWS           | `opa:get-env-providers`                 | Retrieves AWS environment provider data based on a reference to an AWS environment entity.         | [OPA Get Env Providers](https://github.com/awslabs/harmonix/blob/main/backstage-plugins/plugins/scaffolder-backend-module-aws-apps/src/actions/get-env-providers/get-env-providers.ts) | environmentRef*                                                                                                                 |
| AWS           | `opa:create-secret`                     | Creates secrets in AWS Secrets Manager.                                                            | [OPA Create Secret](https://www.npmjs.com/package/@aws/plugin-scaffolder-backend-aws-apps-for-backstage)                                                                             | secretName*, description, region, tags                                                                                          |
| AWS           | `opa:createRepoAccessToken:gitlab`     | Creates a GitLab repository access token and stores it in AWS Secrets Manager.                     | [OPA Create Repo Access Token](https://www.npmjs.com/package/@aws/plugin-scaffolder-backend-aws-apps-for-backstage)                                                                  | repoUrl*, projectId*, secretArn*, region                                                                                         |
| AWS           | `opa:get-platform-metadata`            | Retrieves metadata about the OPA (Open Policy Agent) on AWS platform.                             | [OPA Get Platform Metadata](https://www.npmjs.com/package/@aws/plugin-scaffolder-backend-aws-apps-for-backstage)                                                                     | envConfig*                                                                                                                       |
| AWS           | `opa:get-ssm-parameters`                | Retrieves AWS SSM parameter values for specified environment providers.                              | [OPA Get SSM Parameters](https://www.npmjs.com/package/@aws/plugin-scaffolder-backend-aws-apps-for-backstage)                                                                       | paramKeys*, envProviders*                                                                                                        |
...
| GitHub       | `github:autolinks:create`    | Create autolink references for GitHub repositories, linking keywords to specific URLs in issues, pull requests, or commits.          | [Source](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend-module-github/src/actions/githubAutolinks.ts)                                     | `repoUrl`*, `keyPrefix`*, `urlTemplate`*, `isAlphanumeric`, `token`                                                |
| GitHub       | `github:deployKey:create`    | Creates and stores GitHub Deploy Keys, with the option to encrypt and store the private key as a GitHub secret.                      | [Source](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend-module-github/src/actions/githubDeployKey.ts)                                     | `repoUrl`*, `publicKey`*, `privateKey`*, `deployKeyName`*, `privateKeySecretName`, `token`                          |
| GitHub       | `github:environment:create`  | Creates deployment environments on GitHub with branch or tag policies and environment variables.                                     | [Source](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend-module-github/src/actions/githubEnvironment.ts)                                   | `repoUrl`*, `name`*, `deploymentBranchPolicy`, `customBranchPolicyNames`, `customTagPolicyNames`, `environmentVariables`, `secrets`, `token`, `waitTimer`, `preventSelfReview`, `reviewers` |
| GitHub       | `github:issues:label`        | Adds labels to pull requests or issues on GitHub.                                                                                    | [Source](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend-module-github/src/actions/githubIssuesLabel.ts)                                    | `repoUrl`*, `number`*, `labels`*, `token`                                                                          |
| GitHub       | `github:pages:enable`        | Enables GitHub Pages for a repository with options for build type, source branch, and source path.                                   | [Source](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend-module-github/src/actions/githubPagesEnable.ts)                                    | `repoUrl`*, `buildType`, `sourceBranch`, `sourcePath`, `token`                                                     |
